...
export default function PlaceBidForm({ tenderId }) {
    const form = useForm({
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid w-full items-start gap-4">
                <FormField
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input {...field} placeholder="Enter your bid cost" type="number" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
